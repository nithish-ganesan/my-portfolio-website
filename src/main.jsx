...
function App() {
  ...
  return <>
    ...
    <header><a className="brand" href="#home">NG</a><nav><a href="#home">Home</a><a href="#about">About</a><a href="#experience">Enterprise</a><a href="#projects">Project</a><a href="#achievements">Achievements</a><a className="nav-contact-link" href="#contact">Contact</a></nav></header>
    <main>
